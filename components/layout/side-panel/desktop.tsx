...
import ViewAttachNote, {
  VIEW_ATTACH_NOTE,
} from "@/app/habits/[id]/components/view-attach-note";
import CollabsNoteGround, {
  COLLABS_NOTE_GROUND,
} from "@/components/card-note/setting/collabs";
import FolderNoteGround, {
  FOLDER_NOTE_GROUND,
} from "@/components/card-note/setting/folder-note";
import InitiateSecureNote, {
  INITIATE_SECURE_NOTE,
} from "@/components/card-note/setting/initiate-secure-note";
import Scheduler, { SCHEDULER } from "@/components/card-note/setting/scheduler";
import SecureNote, {
  SECURE_NOTE,
} from "@/components/card-note/setting/secure-note";
import TagNote, {
  TAG_NOTE_GROUND,
} from "@/components/card-note/setting/tag-note";
...
import ProfileMenu, { PROFILE_MENU } from "@/components/profile-menu";
...
export default function SidePanelDesktop() {
  ...
  return (
    <>
      <Sheet
        open={common?.sidePageOpen && !!common?.groundOpen}
