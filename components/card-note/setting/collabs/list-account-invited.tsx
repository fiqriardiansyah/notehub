            ...
            <Drawer open={isOpen} onOpenChange={onOpenChange}>
                <DrawerContent className="z-50">
                    ...
                    <div className="container-custom flex flex-col gap-3 p-4">
                        <Button disabled={disable} loading={sendInviteMutate.isLoading} onClick={onResend} variant="ghost" className="w-full" title="Resend Invitation">
                            <RotateCw className="mr-2" size={20} /> Resend Invitation
                        </Button>
                        <Button disabled={disable} loading={cancelInvitationMutate.isLoading} onClick={onCancel} variant="destructive" className="w-full" title="Resend Invitation">
