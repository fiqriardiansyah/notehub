...
const SecurePassword = React.forwardRef(
  ({ onFinish }: SecurePasswordProps, ref: any) => {
    ...
    React.useEffect(() => {
      if (!ref) return;
      if (changePassswordMutate.isLoading || setPasswordMutate.isLoading) {
        ref.current = true;
        return;
      }
      ref.current = false;
    }, [changePassswordMutate.isLoading, setPasswordMutate.isLoading, ref]);
...
SecurePassword.displayName = "SecurePassword";
